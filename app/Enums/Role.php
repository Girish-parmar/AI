    ...
    public function navItems(): array
    {
        return match ($this) {
            self::SuperAdmin => [
                ...
                ['label' => 'Subscriptions', 'available' => true, 'route' => 'admin.subscription-plans.index'],
            ...
            self::Admin => [
                ...
                ['label' => 'Subscriptions', 'available' => true, 'route' => 'admin.subscription-plans.index'],
                ['label' => 'Purchases & Orders', 'available' => true, 'route' => 'admin.transactions.index'],
            ...
            self::Monitoring => [
                ...
                ['label' => 'Audit Logs', 'available' => true, 'route' => 'monitoring.audit-logs.index'],
                ['label' => 'Legal & Compliance', 'available' => true, 'route' => 'monitoring.legal-documents.index'],
                ['label' => 'Advertising', 'available' => true, 'route' => 'monitoring.advertisements.index'],
                ['label' => 'Courses & Scripts', 'available' => true, 'route' => 'monitoring.courses.index', 'note' => 'View only'],
                ['label' => 'Subscriptions', 'available' => true, 'route' => 'monitoring.subscription-plans.index', 'note' => 'View only'],
                ...
                ['label' => 'Demo Access', 'available' => true, 'route' => 'monitoring.demo-access.index', 'note' => 'View only'],
            ],
            self::Creator => [
            ...
            self::User => [
                ...
                ['label' => 'Browse Plans', 'available' => true, 'route' => 'user.plans.index'],
            ...
            self::Accounts => [
                ...
                ['label' => 'Courses & Scripts', 'available' => true, 'route' => 'accounts.courses.index', 'note' => 'View only'],
                ['label' => 'Subscriptions', 'available' => true, 'route' => 'accounts.subscription-plans.index', 'note' => 'View only'],
            ],
        };
    }
}
