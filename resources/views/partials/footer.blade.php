@php
    $footerLegalLinks = \App\Models\LegalDocument::published()
    ...
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
        ...
        <ul class="nav">
            ...
            @foreach ($footerLegalLinks as $document)
                <li class="nav-item"><a class="nav-link px-2 text-white-50" href="{{ route('legal.show', $document->type->value) }}">{{ $document->title }}</a></li>
            @endforeach
